...
// add a function to refactor and remove some repeated code.
// This displays a message that is passed to it.
...
document.querySelector('.check').addEventListener('click', function () {
  ...
  if (!guess) {
    ...
    // Code refactoring done here to replace some duplicate code
    // Ternary operator used here, just below:
    // when guess is wrong
  } else if (guess !== secretNumber) {
    if (score > 1) {
  ...
  // This code section removed - this was the initial version and has now been
  // refactored due to some duplicate code.
